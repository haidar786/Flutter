...
class FormUtil {
  ...
  String passwordRegex = r'^.*(?=.{8,20})(?=.*[a-zA-Z])(?=.*\d)(?=.*[!#$%&? "]).*$';
  String passwordInvalidMessage = "8-20 letters, 1 number, 1 special character";

  String validateName(String value) => validate(value, nameRegex, 'name', nameInvalidMessage);
  String validateEmail(String value) => validate(value, emailRegex, 'email', emailInvalidMessage);
  String validatePassword(String value) => validate(value, passwordRegex, 'password', passwordInvalidMessage);
